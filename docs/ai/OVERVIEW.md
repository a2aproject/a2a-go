...
#### Project Overview
The A2A Go SDK is a library for building agentic applications that adhere to the **Agent2Agent (A2A) Protocol**. It provides the infrastructure to create **A2A Servers** (agents that can receives tasks) and **A2A Clients** (applications that consume agent services).
