...
const file_a2a_proto_rawDesc = "" +
	...
	"\n" +
	"A2AService\x12c\n" +
	"\vSendMessage\x12\x1a.a2a.v1.SendMessageRequest\x1a\x1b.a2a.v1.SendMessageResponse\"\x1b\x82\xd3\xe4\x93\x02\x15:\x01*\"\x10/message:send\x12k\n" +
	"\x14SendStreamingMessage\x12\x1a.a2a.v1.SendMessageRequest\x1a\x16.a2a.v1.StreamResponse\"\x1d\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/message:stream0\x01\x12R\n" +
	"\aGetTask\x12\x16.a2a.v1.GetTaskRequest\x1a\f.a2a.v1.Task\"!\xdaA\x04name\x82\xd3\xe4\x93\x02\x14\x12\x12/{name=tasks/*}\x12S\n" +
	"\tListTasks\x12\x18.a2a.v1.ListTasksRequest\x1a\x19.a2a.v1.ListTasksResponse\"\x11\x82\xd3\xe4\x93\x02\v\x12\t/tasks\x12[\n" +
	"\n" +
	"CancelTask\x12\x19.a2a.v1.CancelTaskRequest\x1a\f.a2a.v1.Task\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\"\x19/{name=tasks/*}:cancel\x12s\n" +
	"\x10TaskSubscription\x12\x1f.a2a.v1.TaskSubscriptionRequest\x1a\x16.a2a.v1.StreamResponse\"$\x82\xd3\xe4\x93\x02\x1e\x12\x1c/{name=tasks/*}:subscribe0\x01\x12\xc5\x01\n" +
	" CreateTaskPushNotificationConfig\x12/.a2a.v1.CreateTaskPushNotificationConfigRequest\x1a\".a2a.v1.TaskPushNotificationConfig\"L\xdaA\rparent,config\x82\xd3\xe4\x93\x026:\x06config\",/{parent=tasks/*/pushNotificationConfigs}\x12\xae\x01\n" +
	"\x1dGetTaskPushNotificationConfig\x12,.a2a.v1.GetTaskPushNotificationConfigRequest\x1a\".a2a.v1.TaskPushNotificationConfig\";\xdaA\x04name\x82\xd3\xe4\x93\x02.\x12,/{name=tasks/*/pushNotificationConfigs/*}\x12\xbe\x01\n" +
	"\x1eListTaskPushNotificationConfig\x12-.a2a.v1.ListTaskPushNotificationConfigRequest\x1a..a2a.v1.ListTaskPushNotificationConfigResponse\"=\xdaA\x06parent\x82\xd3\xe4\x93\x02.\x12,/{parent=tasks/*}/pushNotificationConfigs\x12P\n" +
	"\fGetAgentCard\x12\x1b.a2a.v1.GetAgentCardRequest\x1a\x11.a2a.v1.AgentCard\"\x10\x82\xd3\xe4\x93\x02\n" +
	"\x12\b/card\x12\xa8\x01\n" +
	" DeleteTaskPushNotificationConfig\x12/.a2a.v1.DeleteTaskPushNotificationConfigRequest\x1a\x16.google.protobuf.Empty\";\xdaA\x04name\x82\xd3\xe4\x93\x02.*,/{name=tasks/*/pushNotificationConfigs/*}Bs\n" +
	"\n" +
